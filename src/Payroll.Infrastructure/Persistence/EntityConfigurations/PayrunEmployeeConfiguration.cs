...
internal sealed class PayrunEmployeeConfiguration : IEntityTypeConfiguration<PayrunEmployee>
{
    public void Configure(EntityTypeBuilder<PayrunEmployee> builder)
    {
        ...
        builder.Property(e => e.AdminChargesAmount).HasColumnType("numeric(18,2)");
        ...
        builder.Property(e => e.LopDays).HasColumnType("numeric(4,1)");
        builder.Property(e => e.ActualPayableDays).HasColumnType("numeric(4,1)");
