...
internal sealed class EmployeeSalaryStructureConfiguration : IEntityTypeConfiguration<EmployeeSalaryStructure>
{
    public void Configure(EntityTypeBuilder<EmployeeSalaryStructure> builder)
    {
        ...
        builder.Property(e => e.AnnualCTC).IsRequired().HasColumnType("numeric(18,4)");
