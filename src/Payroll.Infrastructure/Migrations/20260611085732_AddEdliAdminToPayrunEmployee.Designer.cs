...
namespace Payroll.Infrastructure.Migrations.PayrollDb
{
    ...
    [Migration("20260611085732_AddEdliAdminToPayrunEmployee")]
    partial class AddEdliAdminToPayrunEmployee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Payroll.Domain.Entities.IncomeTaxConfig", b =>
                {
                    ...
                    b.Property<decimal>("EdliMaxAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(18,4)")
                        .HasDefaultValue(0m)
                        .HasColumnName("edli_max_amount");

                    b.Property<decimal>("EdliRate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(7,4)")
                        .HasDefaultValue(0m)
                        .HasColumnName("edli_rate");

                    b.Property<decimal>("EdliWageCap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(18,4)")
                        .HasDefaultValue(0m)
                        .HasColumnName("edli_wage_cap");
                    ...
                    b.Property<decimal>("Pan206AARate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric(7,4)")
                        .HasDefaultValue(0m)
                        .HasColumnName("pan206aa_rate");
            ...
            modelBuilder.Entity("Payroll.Domain.Entities.PayrunEmployee", b =>
                {
                    ...
                    b.Property<decimal>("AdminChargesAmount")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("admin_charges_amount");
                    ...
                    b.Property<decimal>("TaxableGrossPay")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("taxable_gross_pay");
                    ...
                    b.Property<decimal>("VpfPercent")
                        .HasColumnType("numeric(7,2)")
                        .HasColumnName("vpf_percent");
