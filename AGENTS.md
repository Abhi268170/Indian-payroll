# Indian Payroll SaaS — Codex Rules
...
**See:** `.Codex/skills/testing.md` for full TDD patterns.
...
**See:** `.Codex/skills/security.md` for full patterns.
...
**See:** `.Codex/skills/database.md` for migration patterns.
...
| Area | Skill file |
|---|---|
| Payroll engine (TDS/PF/ESI/PT/LWF calc) | `.Codex/skills/payroll-engine.md` |
| .NET API + MediatR + FluentValidation | `.Codex/skills/dotnet-api.md` |
| EF Core + Dapper + migrations | `.Codex/skills/database.md` |
| React + TypeScript + Zod + RHF | `.Codex/skills/react-frontend.md` |
| xUnit + Testcontainers + Vitest + Playwright | `.Codex/skills/testing.md` |
| Auth + encryption + tenant isolation + RBAC | `.Codex/skills/security.md` |
| Docker + Hangfire + Redis + MinIO + MailHog | `.Codex/skills/infrastructure.md` |
