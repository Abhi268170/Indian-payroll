...
public class PFCalculatorTests
{
    ...
    {
        Outputs.PFResult result = PFCalculator.Compute(20000m, 20000m, 0m, 26, RestrictedConfig(), optOut: true);
    ...
    public void BelowCap_Employee12Percent()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(10000m, 10000m, 0m, 26, RestrictedConfig(), optOut: false);
    ...
    public void AboveCap_Restricted_BothEmployeeAndEmployerCappedAt15000()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(30000m, 30000m, 0m, 26, RestrictedConfig(), optOut: false);
    ...
    public void AboveCap_Unrestricted_EmployerUsesActualWage()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(30000m, 30000m, 0m, 26, UnrestrictedConfig(), optOut: false);
    ...
    public void Lop_ConsiderSalaryOnLop_True_UsesProrated()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(prorated, 15000m, lopDays: 2m, baseDays: 26, RestrictedConfig(considerSalaryOnLop: true), optOut: false);
    ...
    public void Lop_ConsiderSalaryOnLop_False_UsesFullStructure()
    {
        ...
        decimal prorated = Math.Round(15000m * 24m / 26m, 2, MidpointRounding.AwayFromZero);
        Outputs.PFResult result = PFCalculator.Compute(prorated, 15000m, lopDays: 2m, baseDays: 26, RestrictedConfig(considerSalaryOnLop: false), optOut: false);
    ...
    public void ProRateRestrictedPfWage_ProratesCapByPaidDays()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(proratedPfWage, 20000m, lopDays: 2m, baseDays: 26,
    ...
    {
        Outputs.PFResult result = PFCalculator.Compute(10000m, 10000m, 0m, 26, WithEdli(RestrictedConfig()), optOut: false);
    ...
    public void Edli_AboveWageCap_CappedAt15kWageAndMaxAmount()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(30000m, 30000m, 0m, 26, WithEdli(UnrestrictedConfig()), optOut: false);
    ...
    {
        Outputs.PFResult result = PFCalculator.Compute(10000m, 10000m, 0m, 26, WithEdli(RestrictedConfig()), optOut: true);
        result.EdliCharge.Should().Be(0m);
        result.AdminCharge.Should().Be(0m);
    }
    ...
    public void Vpf_IsPercentOfEmployeePfWage_NotARupeeAmount()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(10000m, 10000m, 0m, 26, RestrictedConfig(), optOut: false, vpfPercent: 5m);
    ...
    public void Vpf_OnCappedWage_WhenRestricted()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(30000m, 30000m, 0m, 26, RestrictedConfig(), optOut: false, vpfPercent: 10m);
    ...
    public void Contributions_AreWholeRupees()
    {
        ...
        Outputs.PFResult result = PFCalculator.Compute(12345m, 12345m, 0m, 26, RestrictedConfig(), optOut: false);
