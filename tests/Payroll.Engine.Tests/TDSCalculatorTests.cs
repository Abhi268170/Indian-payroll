...
public sealed class TDSCalculatorTests
{
    ...
    {
        TDSResult result = TDSCalculator.Compute(50_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    public void Income_At87AThreshold_FullRebateApplied_ZeroTax()
    {
        ...
        TDSResult result = TDSCalculator.Compute(12_75_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    public void Income_15L_Gross_CorrectSlabTax()
    {
        ...
        TDSResult result = TDSCalculator.Compute(15_75_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    public void Section206AA_NoPan_TwentyPercentFlatRate()
    {
        ...
        TDSResult result = TDSCalculator.Compute(15_75_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: false, Config, monthsRemainingInFY: 12);
    ...
    public void Section206AA_NoPan_IsHigherThanSlabTax_SlabIgnored()
    {
        ...
        TDSResult result = TDSCalculator.Compute(5_00_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: false, Config, monthsRemainingInFY: 12);
    ...
    public void PriorEmployerYTD_TaxableIncome_AddsToProjectedGross()
    {
        ...
        TDSResult result = TDSCalculator.Compute(10_75_000m, 2_00_000m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    public void PriorEmployerYTD_ReducesRemainingTax()
    {
        ...
        TDSResult result = TDSCalculator.Compute(15_75_000m, 0m, priorEmployerYTDTDSDeducted: 50_000m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    public void PriorEmployerYTD_ExceedsTotalTax_ZeroMonthlyTDS()
    {
        ...
        TDSResult result = TDSCalculator.Compute(15_75_000m, 0m, priorEmployerYTDTDSDeducted: 2_00_000m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    public void MonthsRemaining_6_DoublesTDSVsFullYear()
    {
        ...
        TDSResult result = TDSCalculator.Compute(15_75_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 6);
    ...
    {
        TDSResult result = TDSCalculator.Compute(15_75_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 0);
    ...
    public void Surcharge_10Pct_For_IncomeBetween50L_And_1Cr()
    {
        ...
        // total: 15,78,720
        TDSResult result = TDSCalculator.Compute(60_75_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    [Fact]
    public void CurrentEmployerYTD_ReducesRemainingTax()
    {
        // Same as PriorEmployerYTD_ReducesRemainingTax but using currentEmployerYTD
        // total annual tax 1,09,200, currentYTD 50,000 → remaining 59,200 → /12 = 4,933.33
        TDSResult result = TDSCalculator.Compute(15_75_000m, 0m, 0m, currentEmployerYTDTDSDeducted: 50_000m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    [Fact]
    public void CurrentAndPriorEmployerYTD_BothReduceRemainingTax()
    {
        // total annual tax 1,09,200, currentYTD 30,000 + priorYTD 20,000 = 50,000 → remaining 59,200 → /12 = 4,933.33
        TDSResult result = TDSCalculator.Compute(15_75_000m, 0m, priorEmployerYTDTDSDeducted: 20_000m, currentEmployerYTDTDSDeducted: 30_000m, hasPan: true, Config, monthsRemainingInFY: 12);
    ...
    public void MarginalRelief_IncomeOneRupeeAbove50LThreshold()
    {
        ...
        TDSResult result = TDSCalculator.Compute(50_75_001m, 0m, 0m, currentEmployerYTDTDSDeducted: 0m, hasPan: true, Config, monthsRemainingInFY: 12);
